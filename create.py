...
def random_ua():
    ...
    ua1 = 'Mozilla/5.0 (Linux; U; Android 4.4.3; en-us; KFASWI Build/KTU84M) AppleWebKit/537.36 (KHTML, like Gecko) Silk/3.68 like Chrome/39.0.2171.93 Safari/537.36'
...
try:
    key1 = open('/data/data/com.termux/files/usr/bin/.mrUMARxxx-cov', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.mrUMARxxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrUMARxxx-cov', 'r').read()
...
def Create():
    ...
    def strt():
       try:
           ...
           pass
    file="/sdcard/Scientist-Auto-FB/CREATE-OK.txt"
    u=5000
    clear()
